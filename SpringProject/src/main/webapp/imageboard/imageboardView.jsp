...
onclick="location.href='/miniproject/imageboard/imageboardList.do?pg=1'">
...
function bigImage(){
	...
	img.setAttribute("src", "http://localhost:8080/miniproject/storage/${imageboardDTO.getImage1()}");
