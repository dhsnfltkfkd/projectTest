...
<body>
<form name="boardWriteForm" id="boardWriteForm" method="post" action="/SpringProject/board/boardWrite.do">
<h2>글쓰기</h2>
<table border="1" cellpadding="3" cellspacing="0">
	...
	<tr>
		...
		<input type="button" value="글쓰기" id="checkBoardWrite" onclick="return false;">
...
$(document).ready(function() {
	$('#checkBoardWrite').click(function(){
		...
		if($('#subject').val()=='')
			$('#subjectDiv').text('제목 입력').css('color', 'red');
		else if($('#content').val()=='')
			$('#contentDiv').text('내용 입력').css('color', 'red');
		else
